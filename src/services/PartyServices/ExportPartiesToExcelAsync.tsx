...
export const ExportPartiesToExcelAsync = async () => {
  try {
    const jwtToken = getCookie("jwtToken");

    const response = await fetch(
      "http://localhost:5006/api/Party/exportPartiesToExcel",
      {
        method: "GET",
        headers: {
    ...
    a.href = url;
    a.download = "parties.xlsx"; // Имя файла, которое будет предложено для загрузки
