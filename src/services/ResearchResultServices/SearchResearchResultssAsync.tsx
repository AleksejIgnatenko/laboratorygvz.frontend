...
export const SearchResearchResultssAsync = async (
  searchQuery: string,
  pageNumber: number
): Promise<{
  researchResults: ResearchResultModel[];
  ...
  try {
    ...
    const response = await fetch(
      `http://localhost:5005/api/ResearchResults/searchResearchResults?searchQuery=${searchQuery}&pageNumber=${pageNumber}`,
      {
        method: "GET",
        headers: {
