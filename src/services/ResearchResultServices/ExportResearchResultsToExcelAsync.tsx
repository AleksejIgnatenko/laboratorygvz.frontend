...
export const ExportResearchResultsToExcelAsync = async () => {
  try {
    const jwtToken = getCookie("jwtToken");

    const response = await fetch(
      "http://localhost:5005/api/ResearchResults/exportResearchResultsToExcel",
      {
        method: "GET",
        headers: {
    ...
    a.href = url;
    a.download = "researchResults.xlsx"; // Имя файла, которое будет предложено для загрузки
